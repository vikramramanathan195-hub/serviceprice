  ...
  return (
    <AppShell>
      ...
      <RoleGate
        ...
        reason="External partners see manufacturing cost and lead time for their own component only — not the deal pipeline. Open a product's Manufacturing BOM to see your component."
      >
